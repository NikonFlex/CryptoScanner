namespace CryptoParser.Models
{
   namespace Tables
   {
      [SimpleTable("CurrencyOnlyMaker")]
      public class CurrencyTableOnlyMaker : ITable
      {
         ...
         public CurrencyTableOnlyMaker(CVBType cvb, string currency)
         {
         ...
         private List<object> createRow(Bank sellBank)
         {
            ...
            foreach (Bank buyBank in _cvbData.Banks)
            {
               try
               {
